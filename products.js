    ...
    },
{
        ...
        description: "Conjunto de embrague completo (Placa, Disco y Crapodina) de 310mm y 10 estr�as. Marca LUK, compatible con motores Mercedes Benz OM352 en modelos 1114 and 1517."
    },
{
        id: "P003",
    ...
    },
{
        ...
        description: "Vaso para filtro de aceite fabricado en aluminio de alta calidad. Diseñado espec�ficamente para motores Mercedes Benz OM352, garantizando un ajuste perfecto y durabilidad."
    },
{
        id: "P010",
        ...
        description: "Vaso para filtro de aceite usado/reacondicionado para motores Mercedes Benz OM352. Una opción económica y funcional con la garant�a de calidad original."
    },
{
        id: "P011",
    ...
    },
{
        ...
        description: "Engranaje de avance para árbol de levas, calidad importada. Compatible con motores Mercedes Benz OM352 y OM366. Componente cr�tico para la correcta sincronización del motor."
    },
{
        id: "P018",
    ...
    },
{
        ...
        description: "Buje de balanc�n para motores Mercedes Benz OM352 y OM366. Fabricado en bronce de alta calidad para reducir la fricción y el desgaste en el eje de balancines."
    },
{
        id: "P033",
    ...
    },
{
        ...
        description: "Soporte de balanc�n (números 2, 5 y 6) para motores Mercedes Benz OM352 y OM366. Fabricado en fundición de alta resistencia para un anclaje firme del eje de balancines."
    },
{
        id: "P035",
    ...
    },
{
        ...
        description: "Soporte de balanc�n (números 3 y 4) para motores Mercedes Benz OM352 and OM366. Fabricado en fundición de alta resistencia para un anclaje firme del eje de balancines en las posiciones centrales."
    },
{
        id: "P043",
...
{
        id: "P044",
        name: "CHAVETA CIG�SE�AL 8x13x32mm. OM352/366",
        brand: "Mercedes Benz",
        code: "006888008004",
...
{
        id: "P047",
        name: "BULON CONTRAPESO CIG�SE�AL LARGO OM352",
        brand: "Mercedes Benz",
        code: "3520310071",
        image: "img/products/om352/bulon-contrapeso-ciguenal-largo-om352.jpg",
        description: "Bulón largo para contrapeso de cigüeñal, compatible with motores Mercedes Benz OM352. Fabricado con acero de alta resistencia para soportar las fuerzas centr�fugas del cigüeñal."
    },
{
        id: "P048",
...
{
        id: "P050",
        name: "ENGRANAJE CIG�SE�AL (-0.03) STD OM352/366",
        brand: "Mercedes Benz",
        code: "3520520003",
        image: "img/products/om352/engranaje-ciguenal-om352-std.jpg",
        description: "Engranaje de cigüeñal medida estándar con tolerancia -0.03. Compatible with motores Mercedes Benz OM352 and OM366. Pieza cr�tica de distribución para una sincronización exacta."
    },
{
        id: "P051",
...
{
        id: "P053",
        name: "BULON PUNTA CIG�SE�AL LARGO 24x55 OM352",
        brand: "Mercedes Benz",
        code: "3149901001",
...
{
        id: "P054",
        name: "ENGRANAJE CIG�SE�AL (-0.05) STD OM352/366",
        brand: "Mercedes Benz",
        code: "3520520003",
...
{
        id: "P057",
        name: "DEFLECTOR ACEITE CIG�SE�AL OM352",
        brand: "Mercedes Benz",
        code: "00324",
...
{
        id: "P059",
        name: "BULON CONTRAPESO CIG�SE�AL CORTO 12x45 OM352",
        brand: "Mercedes Benz",
        code: "3520310071",
...
{
        id: "P062",
        name: "PORTA RULEMAN CIG�SE�AL OM352",
        brand: "Mercedes Benz",
        code: "3120310533",
    ...
    },
{
        ...
        description: "Tapón para block de motor, espec�fico para el canal de aceite. Compatible with motores Mercedes Benz OM352. Pieza fundamental para el sellado hermético del circuito de lubricación principal."
    },
{
        id: "P073",
    ...
    },
{
        ...
        description: "Bulón leg�timo para cárter, medida 8x20mm. Compatible con motores Mercedes Benz OM352 y OM366. Se comercializa por par (2 unidades). Incluye arandela de presión para un ajuste seguro y evitar filtraciones."
    },
{
        id: "P076",
    ...
    },
{
        ...
        description: "Perno gu�a para tapa de bancada, medida 8.00mm. Compatible con motores Mercedes Benz OM352. Esencial para asegurar la alineación perfecta de las tapas de bancada durante el armado del motor."
    },
{
        id: "P078",
    ...
    },
{
        ...
        description: "Bulón leg�timo para tapa de distribución, medida 6x70mm. Compatible con motores Mercedes Benz OM352 y OM366. Se comercializa por juego de 5 unidades. Incluye arandela para un sellado y sujeción profesional."
    },
{
        id: "P080",
        ...
        description: "Bulón de bancada para block, medida 15x121mm. Compatible con motores Mercedes Benz OM352 y OM366. Fabricado con acero de máxima resistencia para asegurar la fijación cr�tica de las tapas de bancada del cigüeñal."
    },
{
        id: "P081",
    ...
    },
{
        ...
        description: "Bulón leg�timo para cárter, medida 6x16mm. Compatible with motores Mercedes Benz OM352 and OM366. Se comercializa por juego de 18 unidades. Incluye arandela integrada para una fijación estanca and segura del cárter."
    },
{
        id: "P083",
    ...
    },
{
        ...
        description: "Bulón leg�timo para tapa de distribución, medida 6x22mm. Compatible with motores Mercedes Benz OM352 and OM366. Se comercializa por juego de 8 unidades. Incluye arandela para un sellado and sujeción profesional."
    },
{
        id: "P086",
        name: "CA�O SALIDA BOMBA D/H 1218/OM366/A/LA",
        brand: "Mercedes Benz",
        code: "3884608188",
...
{
        id: "P103",
        name: "CA�O SALIDA DE BOMBA HIDRAULICA 1215 OM366",
        brand: "Mercedes Benz",
        code: "3444608624",
    ...
    },
{
        ...
        description: "Cilindro de freno motor tipo KNORR compatible con motores Mercedes Benz OM366, OM447, OM449 y OM457. Fabricado con materiales de alta resistencia para soportar las exigencias del sistema de frenado auxiliar. Componente esencial para el control del freno motor en veh�culos pesados."
    },
{
        id: "P105",
    ...
    },
{
        ...
        description: "Caño r�gido de bomb�n de embrague para Mercedes Benz L1620 con motor OM366LA. Fabricado en acero de alta resistencia con acabado anticorrosivo. Diseñado para conectar el sistema hidráulico del embrague, garantizando una transmisión eficiente de la presión hidráulica."
    },
{
        id: "P107",
        ...
        description: "Caño r�gido de bomba de embrague para Mercedes Benz L1620 con motor OM366LA. Fabricado en acero de alta resistencia con acabado anticorrosivo. Componente del sistema hidráulico que conecta la bomba de embrague, asegurando una transmisión eficiente de la presión."
    },
{
        id: "P108",
        ...
        description: "Porta crapodina (porta collarin) para motores Mercedes Benz OM366. Fabricado en fundición de alta resistencia. Componente esencial del sistema de embrague que aloja y soporta el collar�n de empuje, garantizando un accionamiento suave y preciso del embrague."
    },
{
        id: "P109",
...
{
        id: "P122",
        name: "CIGUE�AL COMPRESOR KNORR 88 OM366",
        brand: "Mercedes Benz",
        code: "0001314216",
    ...
    },
{
        ...
        description: "Codo de bajada de turbo sin freno (importado) para motores Mercedes Benz OM366A. Fabricado en fundición de alta resistencia térmica. Pieza clave del sistema de escape que conecta la salida del turbocompresor con el resto de la l�nea de escape."
    },
{
        id: "P124",
    ...
    },
{
        ...
        description: "Kit de turbo lateral sin escape para motores Mercedes Benz OM366. Incluye múltiples de admisión y escape, codos, abrazaderas, juntas, buloner�a y tuber�as de aceite necesarias para la instalación o reparación del sistema de turbocompresor. Conjunto completo para una instalación precisa."
    },
{
        id: "P126",
    ...
    },
{
        ...
        description: "Codo de bajada de turbo con freno motor para Mercedes Benz OM366A. Fabricado en fundición de alta resistencia. Incluye el mecanismo de mariposa para el accionamiento del freno motor, esencial para la seguridad y control del veh�culo en pendientes."
    },
{
        id: "P128",
    ...
    },
{
        ...
        description: "Kit de turbo sin escape para Mercedes Benz 1215 con motor OM366. Conjunto completo de componentes para la instalación del sistema de turbocompresor, incluyendo múltiples, abrazaderas, juntas y tuber�as necesarias, pero sin incluir el turbocompresor ni la bajada de escape."
    },
{
        id: "P131",
        ...
        description: "Codo de bajada de turbo preparado para freno motor, compatible con Mercedes Benz OM366A. Fabricado en fundición resistente. Diseño espec�fico para alojar el sistema de mariposa de freno motor (no incluido), asegurando un ajuste perfecto y duradero."
    },
{
        id: "P132",
...
{
        id: "P136",
        name: "JGO.CA�OS INYECTOR OM366",
        brand: "Mercedes Benz",
        code: ">77020",
        image: "img/products/om366/juego-canos-inyector-om366.jpg",
        description: "Juego de caños de inyector para motores Mercedes Benz OM366. Incluye la tuber�a de alta presión completa para el sistema de inyección. Fabricados en acero de alta resistencia para soportar las elevadas presiones de inyección y vibraciones del motor."
    },
{
        id: "P137",
...
{
        id: "P149",
        name: "BULON PUNTA CIG�SE�AL CORTO 24x75 OM366",
        brand: "Mercedes Benz",
        code: "3669901501",
    ...
    },
{
        ...
        description: "Cárter de aceite de motor plano para Mercedes Benz OM366 (serie OH). Fabricado en chapa de acero de alta resistencia. Diseño de perfil bajo ideal para autobuses y veh�culos con espacio reducido debajo del motor. Asegura una correcta reserva y circulación de aceite."
    },
{
        id: "P158",
    ...
    },
{
        ...
        description: "Varilla de nivel de aceite corta, longitud 350mm. Compatible con veh�culos Mercedes Benz 1218, 1620 y motores OM366, OM457. Herramienta esencial para el control preciso del nivel de lubricante en el cárter."
    },
{
        id: "P161",
        ...
        description: "Perno gu�a de tapa de bancada estándar (cónico) para motores Mercedes Benz OM366. Fabricado en acero endurecido. Asegura la alineación precisa de las tapas de bancada durante el montaje, crucial para el correcto funcionamiento del cigüeñal."
    },
{
        id: "P162",
        name: "CA�O GOMA LLENADO ACEITE OM366/366A",
        brand: "Mercedes Benz",
        code: "3760187282",
    ...
    },
{
        ...
        description: "Reducción para brida de cárter de 14x16 mm, compatible con motores Mercedes Benz OM366. Accesorio de conexión roscada fabricado en acero, utilizado para adaptar diferentes diámetros de tuber�as o sensores en el sistema de lubricación."
    },
{
        id: "P166",
    ...
    },
{
        ...
        description: "Llave para tuerca de inyector. Herramienta espec�fica para motores Mercedes Benz OM447 y OM449. Código >05825."
    },
{
        id: "P185",
...
{
        id: "P192",
        name: "CIGUE�AL COMPRESOR KNORR 90 OM447/449",
        brand: "Mercedes Benz",
        code: "4031300214",
...
{
        id: "P194",
        name: "CA�O COMPRESOR 1634/1938 OM447/457 SALIDA 1ER TRAMO",
        brand: "Mercedes Benz",
        code: "6964201226",
...
{
        id: "P195",
        name: "CA�O COMPRESOR 1938/OM447 SALIDA A GOB. LARGO",
        brand: "Mercedes Benz",
        code: "3884207026",
...
{
        id: "P197",
        name: "CA�O COMPRESOR 1634/1938 OM447/457",
        brand: "Mercedes Benz",
        code: "6954207436",
...
{
        id: "P198",
        name: "CA�O COMPRESOR 1938/OM447 GOB.A TANQUE AIRE CORTO",
        brand: "Mercedes Benz",
        code: "3884209826",
    ...
    },
{
        ...
        description: "Bulón de soporte de balanc�n 10x50x1.50. Compatible con motores Mercedes Benz OM447. Código original 000931010369."
    },
{
        id: "P206",
    ...
    },
{
        ...
        description: "Soporte de balanc�n. Compatible con motores Mercedes Benz OM447 y OM449. Código original 4030501236."
    },
{
        id: "P208",
        ...
        description: "Balanc�n de válvulas. Compatible con motores Mercedes Benz OM447 y OM449. Código original 4030500733."
    },
{
        id: "P209",
...
{
        id: "P221",
        name: "ENGRANAJE CIG�SE�AL 43dtes. OM447/449",
        brand: "Mercedes Benz",
...
{
        id: "P224",
        name: "PISTA CIG�SE�AL DELANTERA 105x100 OM447/449/457",
        brand: "Mercedes Benz",
        code: "4420310027",
...
{
        id: "P226",
        name: "POLEA CIG�SE�AL CHAPA 2 CAN.OM447/9",
        brand: "Mercedes Benz",
    ...
    },
{
        ...
        description: "Buje gu�a de tapa de cilindro. Compatible con motores Mercedes Benz OM447 y OM449. Código original 1079910041."
    },
{
        id: "P229",
    ...
    },
{
        ...
        description: "Bulón de cárter leg�timo, medidas 8x35mm. Compatible con motores Mercedes Benz OM447, OM449 y OM457. Código original 910105008014."
    },
{
        id: "P234",
...
{
        id: "P235",
        name: "CA�O GOMA LLENADO ACEITE OM457/O500",
        brand: "Mercedes Benz",
        code: "4570180082",
    ...
    },
{
        ...
        description: "Juego de juntas de marca Elring para descarbonización con sello bajo tapa de aluminio para motores Mercedes Benz OM457. Código original 4570108120. Rubro: TAPA CILINDRO Y V�LVULA. Este kit de alta calidad incluye todas las juntas y sellos necesarios para el mantenimiento integral de la culata, asegurando un sellado estanco y duradero bajo las especificaciones del fabricante original."
    },
{
        id: "P239",
    ...
    },
{
        ...
        description: "Prefiltro flotante para tanque de urea AdBlue. Compatible con motores Mercedes Benz OM457, OM924 y OM926 Euro V. Código original 9585420217. Componente esencial del sistema SCR para filtrar impurezas del l�quido de urea antes de su dosificación."
    },
{
        id: "P242",
        name: "CA�O RAD.AXOR 2044/OM457 SUPERIOR 22/22",
        brand: "Mercedes Benz",
        code: "9405011282",
...
{
        id: "P244",
        name: "CA�O COMPRESOR (SERPENTINA) 5°TRAMO C/SALIDA RECTA O500/OM457 LA",
        brand: "Mercedes Benz",
...
{
        id: "P251",
        name: "CA�O RAD.O500/OM457 FLEXIBLE DE AGUA AL RADIADOR",
        brand: "Mercedes Benz",
        code: "6345010482",
...
{
        id: "P252",
        name: "CA�O RAD.1635/1735 OM457 ATRON INFERIOR",
        brand: "Mercedes Benz",
        code: "6955012882",
        image: "img/products/om457/cano-radiador-atron-inferior-om457.jpg",
        description: "Caño inferior de radiador para modelos Mercedes Benz 1635 y 1735 Atron con motor OM457. Código original 6955012882. Diseño espec�fico para un ajuste preciso y óptimo rendimiento en el sistema de enfriamiento del motor."
    },
{
        id: "P253",
...
{
        id: "P254",
        name: "CA�O GUIA VARILLA NIVEL ACEITE 1634 OM457",
        brand: "Mercedes Benz",
        code: "4570100866",
        image: "img/products/om457/cano-guia-varilla-nivel-aceite-1634-om457.jpg",
        description: "Caño gu�a de varilla de nivel de aceite para motores Mercedes Benz OM457, modelo 1634. Código original 4570100866. Fabricado con materiales de alta resistencia para garantizar un ajuste preciso y durabilidad."
    },
{
        id: "P255",
    ...
    },
{
        ...
        description: "Filtro de aceite tipo elemento para Mercedes Benz Axor con motor OM457. Compatible con marca MAN. Códigos originales 4571840125 y 0001802109. Filtro de alta calidad que garantiza la protección óptima del motor, eliminando part�culas e impurezas del aceite lubricante."
    },
{
        id: "P259",
...
{
        id: "P260",
        name: "CA�O LUBRICACION TURBO OM457 O500",
        brand: "Mercedes Benz",
        code: "5411801422",
        image: "img/products/om457/cano-lubricacion-turbo-om457-o500.jpg",
        description: "Caño de lubricación para turbocompresor en motores Mercedes Benz OM457, modelo O500. Código original 5411801422. Tuber�a de alimentación de aceite al turbo fabricada en acero inoxidable de alta resistencia, garantizando el flujo correcto de lubricante y protección del turbocompresor."
    },
{
        id: "P261",
...
{
        id: "P287",
        name: "CA�O COMPRESOR 1634/OM457 SALIDA 2DO TRAMO",
        brand: "Mercedes Benz",
...
{
        id: "P288",
        name: "CA�O RAD.O500/OM457 SUPERIOR",
        brand: "Mercedes Benz",
        code: "6345010382",
...
{
        id: "P289",
        name: "SENSOR ELECT.GIRO CIGUE�AL/A.LEVA C/CABLE OM457",
        brand: "Mercedes Benz",
        code: "0001539520",
...
{
        id: "P290",
        name: "CA�O RAD.O500/OM457 SUPER. 20/90",
        brand: "Mercedes Benz",
...
{
        id: "P292",
        name: "CA�O COMPRESOR 1938E/OM457",
        brand: "Mercedes Benz",
        code: "6644200236",
...
{
        id: "P293",
        name: "CA�O COMPRESOR (SERPENTINA) INTERMEDIO O500/OM457",
        brand: "Mercedes Benz",
        code: "6344209029",
    ...
    },
{
        ...
        description: "Eje de polea de ventilador para motores Mercedes Benz OM457, compatible con la l�nea Axor. Código original 4572050102. Fabricado en acero de alta resistencia con terminación de precisión para asegurar el correcto alineamiento y durabilidad del sistema de enfriamiento."
    },
{
        id: "P297",
    ...
    },
{
        ...
        description: "Perno gu�a para tapa de cilindro (medida 8x35) para motores Mercedes Benz OM457. Código original 0007008217. Pieza de precisión fundamental para el correcto centrado y montaje de la tapa de cilindros sobre el bloque motor."
    },
{
        id: "P299",
    ...
    },
{
        ...
        description: "Deflector para carcaza de distribución de motores Mercedes Benz OM457. Código original 4570100270. Componente de protección fabricado en tecnopol�mero de alta resistencia al calor y aceites, diseñado para dirigir correctamente el flujo de lubricante dentro de la tapa de distribución."
    },
{
        id: "P302",
    ...
    },
{
        ...
        image: "img/products/om457/junta-carter-om457.jpg",
        description: "Junta de cárter de aceite para motores Mercedes Benz OM457. Códigos originales 4470140322 y 4570140222. Fabricada en material de alta resistencia térmica y qu�mica para asegurar un sellado perfecto y duradero, evitando filtraciones de aceite en la base del motor."
    },
{
        id: "P304",
        ...
        description: "Depósito de expansión para radiador de Mercedes Benz O500 y motores OM457. Código original 6295000049. Fabricado en pol�mero reforzado de alta resistencia a la presión y temperaturas extremas, diseñado para el correcto control del nivel y expansión del l�quido refrigerante."
    },
{
        id: "P305",
    ...
    },
{
        ...
        description: "Kit completo de reparación para bomba de agua en motores Mercedes Benz OM457. Incluye rodamiento, sello y componentes cr�ticos para restaurar el flujo y enfriamiento del motor."
    },
{
        id: "P310",
    ...
    },
{
        ...
        description: "Paleta de ventilador plástica de 9 palas y 700mm de diámetro. Giro inverso, diseñada espec�ficamente para ómnibus Mercedes Benz O-500RSD with motores OM457 and OM926. Códigos originales 4752050706 y 4752050006. Alta eficiencia en el flujo de aire para el sistema de refrigeración."
    },
{
        id: "P314",
        ...
        description: "Tensor de correa automático para motores Mercedes Benz OM457LA, compatible con la l�nea Axor. Código original 4572001670. Rubro: Refrigeración. Componente de alta precisión para mantener la tensión óptima de las correas de mando."
    },
{
        id: "P315",
    ...
    },
{
        ...
        image: "img/products/om457/tensor-correa-axor-2035-om457.jpg",
        description: "Tensor de correa automático para motores Mercedes Benz OM457LA, espec�fico para la l�nea Axor 2035. Compatible con múltiples códigos originales. Rubro: Refrigeración. Garantiza el correcto funcionamiento de las correas auxiliares y la refrigeración del motor."
    },
{
        id: "P318",
    ...
    },
{
        ...
        image: "img/products/om457/bomba-agua-turbina-135mm-om457.png",
        description: "Bomba de agua completa con turbina de 135mm para motores Mercedes Benz OM457. Compatible con modelos 1634E, 1938, chasis O-400 y l�nea Axor. Códigos originales: 4572000101, 4572001601, 4572004701, 4572007001. Rubro: Refrigeración. Rendimiento superior para sistemas de enfriamiento de alta demanda."
    },
{
        id: "P323",
    ...
    },
{
        ...
        description: "Múltiple de escape para motores Mercedes Benz OM457LA, compatible con la l�nea Axor modelos 2035, 2040 y 2045. Códigos originales: 4571420901 y 4571421501. Rubro: Múltiples (Admisión y Escape). Fabricado con fundición de gran durabilidad y diseñado para soportar el régimen de trabajo pesado."
    },
{
        id: "P327",
...
{
        id: "P330",
        name: "CA�O COMPRESOR O-400 OM457 SALIDA",
        brand: "Mercedes Benz",
        code: "6644200236",
        originalCode: "6644200236",
...
{
        id: "P332",
        name: "CA�O REFRIGERACION COMPRESOR OM457",
        brand: "Mercedes Benz",
        code: "4572002052",
...
{
        id: "P334",
        name: "CA�O COMPRESOR 1634/OM457",
        brand: "Mercedes Benz",
        code: "6964207436",
...
{
        id: "P335",
        name: "CA�O REFRIGERACION COMPRESOR 1938E/OM457",
        brand: "Mercedes Benz",
        code: "4572000542",
...
{
        id: "P336",
        name: "CA�O COMPRESOR 1938/OM457 A GOBERNADOR",
        brand: "Mercedes Benz",
...
{
        id: "P339",
        name: "CA�O REFRIGERACION COMPRESOR 1938/OM457",
        brand: "Mercedes Benz",
        code: "4572000452",
    ...
    },
{
        ...
        image: "img/products/om457/juego-junta-flapers-85mm-om457.jpg",
        description: "Juego de juntas con flapers para compresores de 85mm en motores Mercedes Benz OM457 (Versión Monocil�ndrico Tapa Larga). Códigos originales: 0011300815, 3661300120, 0011301015. Rubro: Compresor. Kit completo de alta calidad diseñado para restaurar la estanqueidad y eficiencia del sistema de válvulas del compresor."
    },
{
        id: "P341",
        name: "CA�O COMPRESOR ENTRADA APU 1938 OM457",
        brand: "Mercedes Benz",
        code: "6964207136",
...
{
        id: "P342",
        name: "CA�O COMPRESOR 1634/OM457 SALIDA",
        brand: "Mercedes Benz",
        code: "6954200136",
...
{
        id: "P343",
        name: "CA�O COMPRESOR O-400 OM457E",
        brand: "Mercedes Benz",
        code: "6644200136",
        originalCode: "6644200136",
        image: "img/products/om457/cano-compresor-o400-om457e.jpg",
        description: "Caño de compresor para chasis de ómnibus Mercedes Benz O-400 con motor OM457E. Código original 6644200136. Rubro: Compresor. Fabricado con acero de alta resistencia y diseño espec�fico para el ruteo de aire en aplicaciones de transporte de pasajeros."
    },
{
        id: "P344",
        name: "CA�O REFRIGERACION COMPRESOR 1938/OM457",
    ...
    },
{
        ...
        description: "Elemento filtrante Racor (Parker) para combustible/separador de agua. Modelo R120L-10MB AQII. Compatible con motores Mercedes Benz OM457 y OM906. Código original 9584770015. Rubro: Filtro Combustible. Utiliza tecnolog�a Aquabloc Plus para una separación superior de agua y contaminantes."
    },
{
        id: "P355",
...
{
        id: "P358",
        name: "CA�O INYECTOR OM457 (ELECT.) 1634/1938",
        brand: "Mercedes Benz",
...
{
        id: "P361",
        name: "POLEA CIG�SE�AL CHAPA 9PK OM457",
        brand: "Mercedes Benz",
        code: "4570351212",
    ...
    },
{
        ...
        description: "Tapa roscada de entrada de aceite frontal para motores Mercedes Benz OM457 y chasis 1718. Código original 3520100468. Rubro: BLOCK DE MOTOR Y C�RTER. Fabricada en material plástico de alta resistencia al calor y aceites, asegurando un cierre hermético para evitar fugas y contaminación del lubricante."
    },
{
        id: "P363",
        ...
        description: "Tapa superior de válvula para motores Mercedes Benz OM457. Código original 4570100930. Rubro: TAPA CILINDRO Y V�LVULA. Fabricada en material de alta resistencia térmica para proteger los componentes del tren de válvulas y asegurar un sellado estanco en la culata."
    },
{
        id: "P364",
        ...
        description: "O'ring inferior para la camisa porta inyector de motores Mercedes Benz OM904, OM906 y OM457. Códigos originales 5419970745 y 5419970345. Rubro: TAPA CILINDRO Y V�LVULA. Fabricado en material elastómero de alta resistencia térmica para asegurar un sellado estanco contra el refrigerante y evitar fugas hacia la cámara de combustión."
    },
{
        id: "P365",
        name: "CA�O GUIA VARILLA NIVEL ACEITE CORTO 1620/OM457",
        brand: "Mercedes Benz",
        code: "3760108566",
        originalCode: "3760108566",
        image: "img/products/om457/cano-guia-varilla-corto-om457.jpg",
        description: "Caño gu�a corto para la varilla de nivel de aceite, compatible con camiones Mercedes Benz 1620 y motores OM457. Código original 3760108566. Rubro: BLOCK DE MOTOR Y C�RTER. Fabricado en material metálico resistente para asegurar la correcta inserción y protección de la varilla de medición."
    },
{
        id: "P366",
        ...
        description: "Sensor de ox�geno y temperatura de gases de escape para motores Mercedes Benz OM906, OM924 y OM926. Código original 0061530528. Rubro: INSTRUMENTAL. Componente de alta precisión esencial para el monitoreo y control de emisiones, asegurando un funcionamiento eficiente del sistema de escape y la gestión del motor."
    },
{
        id: "P367",
        ...
        description: "Manguera de filtro de aire para Mercedes Benz O500 y camiones 1725/1726 con motores OM906 y OM926. Código original 3825200001. Rubro: ADMISI�N. Fabricada en caucho reforzado de alta calidad para asegurar un flujo de aire óptimo y estanco hacia el motor, resistiendo vibraciones y temperaturas de operación."
    },
{
        id: "P368",
        ...
        description: "Tapa superior de válvula fabricada en material plástico de alta resistencia para motores Mercedes Benz OM906 y OM926. Código original 9060101030. Rubro: TAPA CILINDRO Y V�LVULA. Diseñada para proteger los componentes del tren de válvulas y asegurar un sellado estanco en la culata, resistiendo las altas temperaturas del motor."
    },
{
        id: "P369",
    ...
    },
{
        ...
        description: "Manguera de dirección hidráulica que conecta la bomba al depósito para chasis Mercedes Benz OF1721 y OF1722 con motor OM906. Código original 3844661181. Rubro: DIRECCI�N. Fabricada en caucho de alta resistencia a la presión y temperatura del fluido hidráulico, diseñada para asegurar un retorno eficiente del aceite al depósito del sistema de dirección."
    },
{
        id: "P372",
    ...
    },
{
        ...
        description: "Amortiguador delantero para chasis de ómnibus Mercedes Benz O500 con motores OM906 y OM926. Códigos originales 3823230100, 6283230100 y 6283230400. Rubro: EL�STICO-SUSPENSI�N-AMORT. Fabricado con tecnolog�a de alta calidad para garantizar una conducción suave y segura, diseñado para soportar las exigencias del transporte de pasajeros."
    },
{
        id: "P375",
        ...
        description: "Cubo de acople para ventilador compatible con chasis Mercedes Benz OHL1618, O500 y motores OM904 y OM906. Código original 4752057604. Rubro: REFRIGERACI�N. Fabricado en fundición de alta resistencia para transmitir el movimiento del motor al ventilador de refrigeración, asegurando un enfriamiento eficiente del sistema."
    },
{
        id: "P376",
        name: "CA�O TEE UNION DE TUBOS DE AGUA O500/OM904/924/OM906/926",
        brand: "Mercedes Benz",
        code: "3685000094",
    ...
    },
{
        ...
        description: "�rbol de levas completo con engranaje para motores Mercedes Benz OM906. Código original 9060501401. Rubro: DISTRIBUCI�N. Componente cr�tico del sistema de distribución fabricado con acero de alta resistencia, diseñado para controlar la apertura y cierre de las válvulas con precisión, garantizando el rendimiento óptimo del motor."
    },
{
        id: "P378",
        name: "CA�O LLENADO ACEITE MOTOR OM906 O500",
        brand: "Mercedes Benz",
        code: "9060100182",
        originalCode: "9060100182",
        image: "img/products/om906/cano-llenado-aceite-om906.jpg",
        description: "Caño de llenado de aceite para motores Mercedes Benz OM906 en chasis O500. Código original 9060100182. Rubro: BLOCK DE MOTOR Y C�RTER. Fabricado en caucho de alta resistencia térmica para asegurar un llenado seguro y estanco del aceite lubricante, diseñado para soportar las temperaturas del vano motor."
    },
{
        id: "P379",
    ...
    },
{
        ...
        description: "Flexible de combustible para chasis Mercedes Benz OF1417 y O500 con motores OM906 LA y OM924. Código original 6934707064. Rubro: FLEXIBLES Y R�GIDOS. Fabricado en caucho de alta resistencia al gasoil con refuerzos internos, diseñado para asegurar una conducción segura y estanca del combustible desde el tanque hacia el sistema de inyección."
    },
{
        id: "P383",
        name: "CA�O COMPRESOR (SERPENTINA) APU OM906/O500",
        brand: "Mercedes Benz",
        code: "3824201828 / 3824208531",
        originalCode: "3824201828 / 3824208531",
        image: "img/products/om906/cano-compresor-serpentina-om906.jpg",
        description: "Caño compresor tipo serpentina para APU (Auxiliary Power Unit) de chasis Mercedes Benz O500 con motor OM906. Códigos originales 3824201828 y 3824208531. Rubro: COMPRESOR. Fabricado en acero con recubrimiento anticorrosivo, diseñado para conducir el aire comprimido de manera eficiente en el sistema neumático del veh�culo."
    },
{
        id: "P384",
        name: "CA�O COMPRESOR O500/ OM906",
        brand: "Mercedes Benz",
        ...
        description: "Caño de compresor para chasis Mercedes Benz O500 con motor OM906. Códigos originales 3824200128, 3824205732 y 3824208934. Rubro: COMPRESOR. Fabricado en material de alta resistencia para soportar la presión y temperatura del sistema de aire comprimido, asegurando una conexión fiable y duradera."
    },
{
        id: "P385",
        ...
        description: "Filtro de aceite MANN HU945/2 L para motores Mercedes Benz OM906, OM924 y OM926, compatible con modelos 1624 y 1933S. C�digo original 0001801709. Rubro: LUBRICACI�N. Filtro de alta eficiencia dise�ado para garantizar la limpieza del aceite lubricante, protegiendo los componentes internos del motor contra el desgaste."
    },
{
        id: "P386",
        name: "CA�O RAD.O500 OM906/926 REFR. CAJA A MOTOR",
        brand: "Mercedes Benz",
        ...
        description: "Ca�o de radiador para chasis Mercedes Benz O500 con motores OM906 y OM926, utilizado para la refrigeraci�n de la caja al motor. C�digos originales 3825015682 y 6645018882. Rubro: RADIADOR. Fabricado con materiales resistentes al calor y la presi�n, garantizando un flujo �ptimo de refrigerante en el sistema."
    },
{
        id: "P387",
        ...
        description: "Varilla de nivel de aceite para camiones Mercedes Benz Atego y Axor con motores OM906 y OM926, modelos 17-20. C�digo original 9260105072. Rubro: BLOCK DE MOTOR Y C�RTER. Fabricada con materiales de alta calidad para una medici�n precisa y resistencia a la corrosi�n."
    },
{
        id: "P388",
        ...
        description: "M�ltiple de admisi�n fabricado en material pl�stico de alta resistencia para motores Mercedes Benz OM906 y OM926. C�digos originales 9060901654 y 9060901642. Rubro: 140-M�LTIPLES(ADMIS. Y ESCAPE). Dise�ado para optimizar el flujo de aire hacia el motor, garantizando durabilidad y ligereza."
    },
{
        id: "P389",
        ...
        description: "Tapa de m�ltiple de admisi�n fabricada en aluminio de alta calidad para motores Mercedes Benz OM906 y OM926. C�digo original 9060980617. Rubro: M�LTIPLES(ADMIS. Y ESCAPE). Componente dise�ado para un sellado perfecto y resistencia a la corrosi�n, garantizando la integridad del sistema de admisi�n."
    },
{
        id: "P390",
        name: "CA�O ASPIRACION COMPRESOR ATEGO OM906",
        brand: "Mercedes Benz",
        code: "9061301357",
        originalCode: "9061301357",
        image: "img/products/om906/cano-aspiracion-compresor-atego-om906.jpg",
        description: "Ca�o de aspiraci�n para el compresor de camiones Mercedes Benz Atego con motor OM906. C�digo original 9061301357. Rubro: COMPRESOR. Manguera corrugada de alta resistencia dise�ada para el sistema de admisi�n del compresor."
    },
{
        id: "P391",
        name: "CA�O COMPRESOR (SERPENTINA) A APU OM906/O500",
        brand: "Mercedes Benz",
        ...
        description: "Ca�o de compresor tipo serpentina para APU (Auxiliary Power Unit) de chasis Mercedes Benz O500 con motor OM906. C�digos originales 3824201036 y 3824200736. Rubro: COMPRESOR. Tubo de acero en espiral dise�ado para la refrigeraci�n y conducci�n eficiente del aire comprimido."
    },
{
        id: "P392",
        ...
        description: "Buje espaciador o tubo distanciador para la palanca del rodillo tensor, compatible con chasis Mercedes Benz O500, OH1618 y motores OM906. C�digo original 6645527253. Rubro: REFRIGERACI�N. Componente esencial para el correcto alineamiento y funcionamiento del sistema de correas."
    },
{
        id: "P393",
        name: "CA�O COMPRESOR (SERPENTINA) APU OM906/O500",
        ...
        description: "Ca�o de compresor tipo serpentina para APU (Auxiliary Power Unit) de chasis Mercedes Benz O500 con motor OM906. C�digos originales 3824204828 y 3824207429. Rubro: COMPRESOR. Fabricado para soportar el flujo constante de aire comprimido en condiciones de alto rendimiento."
    },
{
        id: "P394",
        ...
        description: "Abrazadera de escape de 90mm (3 1/2 pulgadas) para motores Mercedes Benz OM906. C�digo original 6209970590. Rubro: 490-ESCAPE. Fabricada en material de alta resistencia para un sellado seguro y duradero en el sistema de escape."
    },
{
        id: "P395",
        ...
        description: "Eje tubular para el filtro de aceite de motores Mercedes Benz OM906 and OM926. C�digo original 9061840066. Rubro: LUBRICACI�N. Componente pl�stico de alta calidad dise�ado para el correcto flujo y soporte del elemento filtrante de aceite."
    },
{
        id: "P396",
        name: "CA�O RAD.OM906 2423 A BOMBA AGUA INFERIOR",
        brand: "Mercedes Benz",
        code: "6935019282",
        originalCode: "6935019282",
        image: "img/products/om906/cano-radiador-om906-2423-bomba-agua.jpg",
        description: "Ca�o de radiador para camiones Mercedes Benz 2423 con motor OM906, conexi�n a bomba de agua inferior. C�digo original 6935019282. Rubro: RADIADOR. Fabricado con materiales resistentes a la presi�n y temperatura para un flujo �ptimo de refrigerante."
    },
{
        id: "P397",
        name: "CA�O COMPRESOR 1624 OM906 SALIDA COMPRESOR",
        brand: "Mercedes Benz",
        ...
        description: "Ca�o de salida de compresor para camiones Mercedes Benz 1624 con motor OM906. C�digos originales 6944204426 y 6944200326. Rubro: COMPRESOR. Tubo r�gido de alta precisi�n dise�ado para la descarga segura de aire comprimido desde el compresor."
    },
{
        id: "P398",
        ...
        description: "Junta para el radiador de aceite de motores Mercedes Benz OM906 y OM926. C�digos originales 9061880280 y 9261880080. Rubro: JUNTAS. Fabricada en material de alta calidad para garantizar un sellado perfecto y prevenir fugas de aceite en el sistema de lubricaci�n."
    },
{
        id: "P399",
        ...
        description: "Soporte de motor trasero para camiones Mercedes Benz Axor 1933 con motor OM906. C�digos originales 9402401118 y 9402401218. Rubro: SUSPENSI�N DE MOTOR. Fabricado con materiales de alta resistencia para absorber vibraciones y garantizar una sujeci�n segura del motor."
    },
{
        id: "P400",
        name: "CA�O RETORNO ACEITE OM906",
        brand: "Mercedes Benz",
        code: "9061871801",
        originalCode: "9061871801",
        image: "img/products/om906/cano-retorno-aceite-om906.jpg",
        description: "Ca�o de retorno de aceite para motor Mercedes Benz OM906. C�digo original 9061871801. Rubro: LUBRICACI�N. Conducto met�lico dise�ado para asegurar el retorno eficiente del aceite al c�rter, fabricado con materiales resistentes a la corrosi�n y alta temperatura."
    },
{
        id: "P401",
        ...
        description: "Manguera para el dep�sito de compensaci�n de camiones Mercedes Benz Atego 1725 con motor OM906. C�digo original 9585010982. Rubro: RADIADOR. Fabricada con materiales de alta durabilidad para resistir la presi�n y temperatura del sistema de enfriamiento."
    },
{
        id: "P402",
        name: "CA�O RAD.1624 COMPLEMENTO DE (19440) OM906",
        brand: "Mercedes Benz",
        code: "6955011882",
        originalCode: "6955011882",
        image: "img/products/om906/cano-radiador-1624-complemento-om906.jpg",
        description: "Ca�o de radiador complementario para camiones Mercedes Benz 1624 con motor OM906. C�digo original 6955011882. Rubro: RADIADOR. Tubo r�gido dise�ado para complementar el sistema de refrigeraci�n principal, asegurando un flujo de refrigerante constante y fiable."
    },
{
        id: "P428",
        name: "VISCOSO SOLO OM906 EURO 1 8 AGUJEROS",
        brand: "Mercedes Benz",
        code: "9062001422",
        originalCode: "9062001422",
        image: "img/products/om906/viscoso-solo-om906-euro1.jpg",
        description: "Viscoso de ventilador (solo) para motores Mercedes Benz OM906 Euro 1. Dise�o de 8 agujeros. C�digo original 9062001422. Rubro: SISTEMA DE REFRIGERACI�N. Componente esencial para el control de temperatura del motor."
    },
{
        id: "P429",
        name: "VISCOSO OM906/926 ATEGO/AXOR ELECTROMAGNETICO C/CABLE",
        brand: "Mercedes Benz",
        code: "9062004223 / 9062001822",
        originalCode: "9062004223 / 9062001822",
        image: "img/products/om906/viscoso-om906-om926-atego-axor.jpg",
        description: "Embrague viscoso electromagn�tico con cable para motores Mercedes Benz OM906 y OM926. Aplicable a camiones Atego y Axor. C�digos originales 9062004223, 9062001822. Rubro: SISTEMA DE REFRIGERACI�N. Tecnolog�a de control preciso para la ventilaci�n del motor."
    },
{
        id: "P430",
        name: "PALETA VENTILADOR VISCOSO OM906 (49980)",
        brand: "Mercedes Benz",
        code: "9062050206",
        originalCode: "9062050206",
        image: "img/products/om906/paleta-ventilador-viscoso-om906.jpg",
        description: "Paleta de ventilador para acople viscoso de motores Mercedes Benz OM906. Referencia 49980. C�digo original 9062050206. Rubro: SISTEMA DE REFRIGERACI�N. Dise�ada para maximizar el flujo de aire a trav�s del radiador."
    },
{
        id: "P431",
        name: "PALETA VENTILADOR PLASTICO OM906 9 PALAS 640mm",
        brand: "Mercedes Benz",
        code: "9062000623",
        originalCode: "9062000623",
        image: "img/products/om906/paleta-ventilador-plastico-om906.jpg",
        description: "Paleta de ventilador de pl�stico de 9 palas y 640mm de di�metro para motores Mercedes Benz OM906. C�digo original 9062000623. Rubro: SISTEMA DE REFRIGERACI�N. Material ligero y resistente para una refrigeraci�n eficiente."
    },
{
        id: "P432",
        name: "CUBO ACOPLE VENTILADOR OM906",
        brand: "Mercedes Benz",
        code: "9062050006",
        originalCode: "9062050006",
        image: "img/products/om906/cubo-acople-ventilador-om906.jpg",
        description: "Cubo de acople para ventilador de motores Mercedes Benz OM906. C�digo original 9062050006. Rubro: SISTEMA DE REFRIGERACI�N. Pieza de conexi�n robusta para el montaje del ventilador."
    },
{
        id: "P433",
        name: "VARILLA ACEITE CORTA OM906/1624",
        brand: "Mercedes Benz",
        code: "9060101672",
        originalCode: "9060101672",
        image: "img/products/om906/varilla-aceite-corta-om906-1624.jpg",
        description: "Varilla de nivel de aceite corta para motores Mercedes Benz OM906, modelo 1624. C�digo original 9060101672. Rubro: BLOCK DE MOTOR Y C�RTER. Herramienta precisa para la medici�n del nivel de aceite."
    },
{
        id: "P434",
        ...
        description: "Varilla de nivel de aceite de 485mm de largo para motores Mercedes Benz OM906 y OM926. Aplicable a camiones Atego y Axor. C�digos originales 9060101072, 9260104272. Rubro: BLOCK DE MOTOR Y C�RTER. Herramienta esencial para el mantenimiento y control del lubricante."
    }
];
